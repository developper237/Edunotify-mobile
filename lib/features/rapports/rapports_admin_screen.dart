...
class _RapportsAdminScreenState extends ConsumerState<RapportsAdminScreen>
  ...
  // L'onglet Abonnement n'est visible que pour les rôles admin
  bool get _peutVoirAbonnement {
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: _peutVoirAbonnement ? 2 : 1,
      vsync: this,
    );
  }
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                const _OngletStats(),
                if (_peutVoirAbonnement) const SubscriptionBody(),
              ],
            ),
          ),
        ],
